...
export const mainRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'quotas',
        loadChildren: () =>
          import('./quotas/quotas.routes').then((m) => m.QuotasRoutes),
      },
      {
        path: 'delegations',
        loadChildren: () =>
          import('./delegations/delegations.routes').then(
            (m) => m.delegationsRoutes
          ),
      },
      {
        path: 'tasks',
      ...
      },
      {
        path: 'opportunities',
        loadChildren: () =>
          import('./oportiunities/opportunities.routes').then(
            (m) => m.OpportunityRoutes
          ),
      },
      {
        path: 'sales',
      ...
      },
      {
        path: 'invoices',
        loadChildren: () =>
          import('./invoices/invoice.routes').then((m) => m.InoviceRoutes),
      },
    ],
  },
];
